...
class NIST44Tests: XCTestCase {
    ...
    func test_C11_dryVolume() {
        ...
        XCTAssertEqual(1.cubicInches, 0.016_387_064.liters)
        XCTAssertEqual(1.cubicInches, 0.000_016_387_064.cubicMeters)
        XCTAssertEqual(1.cubicFeet, 1728.cubicInches)
        XCTAssertEqual(1.cubicFeet, 28.316_846_592.liters)
        XCTAssertEqual(1.cubicFeet, 0.028_316_846_592.cubicMeters)
        XCTAssertEqual(1.liters, 0.001.cubicMeters)
        XCTAssertEqual(1.cubicMeters, 1_000.liters)
    ...
    func test_C11_liquidVolume() {
        XCTAssertEqual(1.fluidDrams(.american), 60.minims(.american))
        XCTAssertEqual(1.fluidDrams(.american), 0.125.fluidOunces(.american))
        XCTAssertEqual(1.fluidDrams(.american), 0.031_25.gills(.american))
        XCTAssertEqual(1.fluidDrams(.american), 0.007_812_5.pints(.american))
        XCTAssertEqual(1.fluidDrams(.american), 0.003_906_25.quarts(.american))
        XCTAssertEqual(1.fluidDrams(.american), 0.000_976_562_5.gallons(.american))
        XCTAssertEqual(1.fluidOunces(.american), 480.minims(.american))
        XCTAssertEqual(1.fluidOunces(.american), 8.fluidDrams(.american))
        XCTAssertEqual(1.fluidOunces(.american), 0.25.gills(.american))
        XCTAssertEqual(1.fluidOunces(.american), 0.062_5.pints(.american))
        XCTAssertEqual(1.fluidOunces(.american), 0.031_25.quarts(.american))
        XCTAssertEqual(1.fluidOunces(.american), 0.007_812_5.gallons(.american))
        XCTAssertEqual(1.fluidOunces(.american), 1.804_687_5.cubicInches)
        XCTAssertEqual(1.gills(.american), 1_920.minims(.american))
        XCTAssertEqual(1.gills(.american), 32.fluidDrams(.american))
        XCTAssertEqual(1.gills(.american), 4.fluidOunces(.american))
        XCTAssertEqual(1.gills(.american), 0.25.pints(.american))
        XCTAssertEqual(1.gills(.american), 0.125.quarts(.american))
        XCTAssertEqual(1.gills(.american), 0.031_25.gallons(.american))
        XCTAssertEqual(1.gills(.american), 7.218_75.cubicInches)
        XCTAssertEqual(1.pints(.american), 7_680.minims(.american))
        XCTAssertEqual(1.pints(.american), 128.fluidDrams(.american))
        XCTAssertEqual(1.pints(.american), 16.fluidOunces(.american))
        XCTAssertEqual(1.pints(.american), 4.gills(.american))
        XCTAssertEqual(1.pints(.american), 0.5.quarts(.american))
        XCTAssertEqual(1.pints(.american), 0.125.gallons(.american))
        XCTAssertEqual(1.pints(.american), 28.875.cubicInches)
        XCTAssertEqual(1.quarts(.american), 15_360.minims(.american))
        XCTAssertEqual(1.quarts(.american), 256.fluidDrams(.american))
        XCTAssertEqual(1.quarts(.american), 32.fluidOunces(.american))
        XCTAssertEqual(1.quarts(.american), 8.gills(.american))
        XCTAssertEqual(1.quarts(.american), 2.pints(.american))
        XCTAssertEqual(1.quarts(.american), 0.25.gallons(.american))
        XCTAssertEqual(1.quarts(.american), 57.75.cubicInches)
        XCTAssertEqual(1.gallons(.american), 61_440.minims(.american))
        XCTAssertEqual(1.gallons(.american), 1_024.fluidDrams(.american))
        XCTAssertEqual(1.gallons(.american), 128.fluidOunces(.american))
        XCTAssertEqual(1.gallons(.american), 32.gills(.american))
        XCTAssertEqual(1.gallons(.american), 8.pints(.american))
        XCTAssertEqual(1.gallons(.american), 4.quarts(.american))
        XCTAssertEqual(1.gallons(.american), 231.cubicInches)
        XCTAssertEqual(1.gallons(.american), 231.cubicInches)
        XCTAssertEqual(1.gallons(.american), 3_785.411_784.milliliters)
        XCTAssertEqual(1.gallons(.american), 3.785_411_784.liters)
        XCTAssertEqual(1.cubicFeet, 1728.cubicInches)
        XCTAssertEqual(1.milliliters, 0.001.liters)
        XCTAssertEqual(1.liters, 1_000.milliliters)
    }
    ...
    func test_C12_mass() {
        XCTAssertEqual(1.ounces, 0.062_5.pounds)
        XCTAssertEqual(1.ounces, 0.000_625.hundredweights(.american))
        XCTAssertEqual(1.ounces, 0.000_031_25.tons(.american))
        XCTAssertEqual(1.ounces, 0.028_349_523_125.kilograms)
        XCTAssertEqual(1.ounces, 0.000_028_349_523_125.metricTons)
        XCTAssertEqual(1.pounds, 16.ounces)
        XCTAssertEqual(1.pounds, 0.01.hundredweights(.american))
        XCTAssertEqual(1.pounds, 0.000_5.tons(.american))
        XCTAssertEqual(1.pounds, 0.453_592_37.kilograms)
        XCTAssertEqual(1.pounds, 0.000_453_592_37.metricTons)
        XCTAssertEqual(1.hundredweights(.american), 1_600.ounces)
        XCTAssertEqual(1.hundredweights(.american), 100.pounds)
        XCTAssertEqual(1.hundredweights(.american), 0.05.tons(.american))
        XCTAssertEqual(1.hundredweights(.american), 45.359_237.kilograms)
        XCTAssertEqual(1.hundredweights(.american), 0.045_359_237.metricTons)
        XCTAssertEqual(1.tons(.american), 32_000.ounces)
        XCTAssertEqual(1.tons(.american), 2_000.pounds)
        XCTAssertEqual(1.tons(.american), 20.hundredweights(.american))
        XCTAssertEqual(1.tons(.american), 907.184_74.kilograms)
        XCTAssertEqual(1.tons(.american), 0.907_184_74.metricTons)
        XCTAssertEqual(1.longTons, 35_840.ounces)
        XCTAssertEqual(1.longTons, 2_240.pounds)
        XCTAssertEqual(1.longTons, 22.4.hundredweights(.american))
        XCTAssertEqual(1.longTons, 1.12.tons(.american))
        XCTAssertEqual(1.longTons, 1_016.046_908_8.kilograms)
        XCTAssertEqual(1.longTons, 1.016_046_908_8.metricTons)
        XCTAssertEqual(1.kilograms, 0.001.metricTons)
        XCTAssertEqual(1.metricTons, 1_000.kilograms)
    }
    
    func test_C13_mass() {
        XCTAssertEqual(1.grains, 0.05.scruples)
        XCTAssertEqual(1.grains, 64.798_91.milligrams)
        XCTAssertEqual(1.grains, 0.064_798_91.grams)
        XCTAssertEqual(1.grains, 0.000_064_798_91.kilograms)
        XCTAssertEqual(1.scruples, 20.grains)
        XCTAssertEqual(1.scruples, 1_295.978_2.milligrams)
        XCTAssertEqual(1.scruples, 1.295_978_2.grams)
        XCTAssertEqual(1.scruples, 0.001_295_978_2.kilograms)
        XCTAssertEqual(1.pennyweights, 24.grains)
        XCTAssertEqual(1.pennyweights, 1.2.scruples)
        XCTAssertEqual(1.pennyweights, 0.4.dramsApothecaries)
        XCTAssertEqual(1.pennyweights, 0.05.ouncesTroy)
        XCTAssertEqual(1.pennyweights, 0.05.ouncesApothecaries)
        XCTAssertEqual(1.pennyweights, 1_555.173_84.milligrams)
        XCTAssertEqual(1.pennyweights, 1.555_173_84.grams)
        XCTAssertEqual(1.pennyweights, 0.001_555_173_84.kilograms)
        XCTAssertEqual(1.drams, 27.343_75.grains)
        XCTAssertEqual(1.drams, 1.367_187_5.scruples)
        XCTAssertEqual(1.drams, 0.062_5.ounces)
        XCTAssertEqual(1.drams, 1_771.845_195_312_5.milligrams)
        XCTAssertEqual(1.drams, 1.771_845_195_312_5.grams)
        XCTAssertEqual(1.drams, 0.001_771_845_195_312_5.kilograms)
        XCTAssertEqual(1.dramsApothecaries, 60.grains)
        XCTAssertEqual(1.dramsApothecaries, 3.scruples)
        XCTAssertEqual(1.dramsApothecaries, 2.5.pennyweights)
        XCTAssertEqual(1.dramsApothecaries, 0.125.ouncesTroy)
        XCTAssertEqual(1.dramsApothecaries, 0.125.ouncesApothecaries)
        XCTAssertEqual(1.dramsApothecaries, 3_887.934_6.milligrams)
        XCTAssertEqual(1.dramsApothecaries, 3.887_934_6.grams)
        XCTAssertEqual(1.dramsApothecaries, 0.003_887_934_6.kilograms)
        XCTAssertEqual(1.ounces, 437.5.grains)
        XCTAssertEqual(1.ounces, 21.875.scruples)
        XCTAssertEqual(1.ounces, 16.drams)
        XCTAssertEqual(1.ounces, 0.062_5.pounds)
        XCTAssertEqual(1.ounces, 28_349.523_125.milligrams)
        XCTAssertEqual(1.ounces, 28.349_523_125.grams)
        XCTAssertEqual(1.ounces, 0.028_349_523_125.kilograms)
        XCTAssertEqual(1.ouncesApothecaries, 480.grains)
        XCTAssertEqual(1.ouncesApothecaries, 24.scruples)
        XCTAssertEqual(1.ouncesApothecaries, 20.pennyweights)
        XCTAssertEqual(1.ouncesApothecaries, 8.dramsApothecaries)
        XCTAssertEqual(1.ouncesApothecaries, 1.ouncesTroy)
        XCTAssertEqual(1.ouncesApothecaries, 31_103.476_8.milligrams)
        XCTAssertEqual(1.ouncesApothecaries, 31.103_476_8.grams)
        XCTAssertEqual(1.ouncesApothecaries, 0.031_103_476_8.kilograms)
        XCTAssertEqual(1.ouncesTroy, 480.grains)
        XCTAssertEqual(1.ouncesTroy, 24.scruples)
        XCTAssertEqual(1.ouncesTroy, 20.pennyweights)
        XCTAssertEqual(1.ouncesTroy, 8.dramsApothecaries)
        XCTAssertEqual(1.ouncesTroy, 1.ouncesApothecaries)
        XCTAssertEqual(1.ouncesTroy, 31_103.476_8.milligrams)
        XCTAssertEqual(1.ouncesTroy, 31.103_476_8.grams)
        XCTAssertEqual(1.ouncesTroy, 0.031_103_476_8.kilograms)
        XCTAssertEqual(1.poundsApothecaries, 5_760.grains)
        XCTAssertEqual(1.poundsApothecaries, 288.scruples)
        XCTAssertEqual(1.poundsApothecaries, 240.pennyweights)
        XCTAssertEqual(1.poundsApothecaries, 96.dramsApothecaries)
        XCTAssertEqual(1.poundsApothecaries, 12.ouncesApothecaries)
        XCTAssertEqual(1.poundsApothecaries, 12.ouncesTroy)
        XCTAssertEqual(1.poundsApothecaries, 1.poundsTroy)
        XCTAssertEqual(1.poundsApothecaries, 373_241.721_6.milligrams)
        XCTAssertEqual(1.poundsApothecaries, 373.241_721_6.grams)
        XCTAssertEqual(1.poundsApothecaries, 0.373_241_721_6.kilograms)
        XCTAssertEqual(1.poundsTroy, 5_760.grains)
        XCTAssertEqual(1.poundsTroy, 288.scruples)
        XCTAssertEqual(1.poundsTroy, 240.pennyweights)
        XCTAssertEqual(1.poundsTroy, 96.dramsApothecaries)
        XCTAssertEqual(1.poundsTroy, 12.ouncesApothecaries)
        XCTAssertEqual(1.poundsTroy, 12.ouncesTroy)
        XCTAssertEqual(1.poundsTroy, 1.poundsApothecaries)
        XCTAssertEqual(1.poundsTroy, 373_241.721_6.milligrams)
        XCTAssertEqual(1.poundsTroy, 373.241_721_6.grams)
        XCTAssertEqual(1.poundsTroy, 0.373_241_721_6.kilograms)
        XCTAssertEqual(1.pounds, 7_000.grains)
        XCTAssertEqual(1.pounds, 350.scruples)
        XCTAssertEqual(1.pounds, 256.drams)
        XCTAssertEqual(1.pounds, 16.ounces)
        XCTAssertEqual(1.pounds, 453_592.37.milligrams)
        XCTAssertEqual(1.pounds, 453.592_37.grams)
        XCTAssertEqual(1.pounds, 0.453_592_37.kilograms)
        XCTAssertEqual(1.milligrams, 0.001.grams)
        XCTAssertEqual(1.milligrams, 0.000_001.kilograms)
        XCTAssertEqual(1.grams, 1_000.milligrams)
        XCTAssertEqual(1.grams, 0.001.kilograms)
        XCTAssertEqual(1.kilograms, 1_000_000.milligrams)
        XCTAssertEqual(1.kilograms, 1_000.grams)
    }
